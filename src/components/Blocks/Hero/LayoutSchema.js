...
const messages = defineMessages({
  HeroBlockSettings: {
    id: 'Hero block settings',
    defaultMessage: 'Hero block settings',
  },
  Default: {
    id: 'Default',
  ...
  DisableEditingOnHeroTitles: {
    id: 'Disable editing on hero titles',
    defaultMessage: 'Disable editing on hero titles',
  },
  ReadOnlySettings: {
    id: 'Read-only settings',
    defaultMessage: 'Read-only settings',
  },
  DisableEditingOnHeroBlockSettings: {
    id: 'Disable editing on hero block settings',
    defaultMessage: 'Disable editing on hero block settings',
  },
  DisableInnerButtons: {
...
export default (intl) => ({
  ...
  properties: {
    ...
    readOnlyTitles: {
      ...
      description: intl.formatMessage(messages.DisableEditingOnHeroTitles),
      type: 'boolean',
    },
    readOnlySettings: {
      title: intl.formatMessage(messages.ReadOnlySettings),
      description: intl.formatMessage(
        messages.DisableEditingOnHeroBlockSettings,
      ),
      type: 'boolean',
    },
    disableInnerButtons: {
